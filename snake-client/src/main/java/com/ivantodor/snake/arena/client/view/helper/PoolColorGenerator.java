 ...
 */
public class PoolColorGenerator implements ColorGenerator
{
    private String[] colorPool = {"#000000", "#000080", "#00008B", "#0000CD", "#0000FF", "#006400", "#008000", "#008080",
            "#008B8B", "#00BFFF", "#00CED1", "#00FA9A", "#00FF00", "#00FF7F", "#00FFFF", "#00FFFF", "#191970", "#1E90FF",
            "#20B2AA", "#228B22", "#2E8B57", "#2F4F4F", "#2F4F4F", "#32CD32", "#3CB371", "#40E0D0", "#4169E1", "#4682B4",
            "#483D8B", "#48D1CC", "#4B0082", "#556B2F", "#5F9EA0", "#6495ED", "#66CDAA", "#696969", "#696969", "#6A5ACD",
            ...
            "#F5F5F5", "#F5FFFA", "#FA8072", "#FAEBD7", "#FAF0E6", "#FF0000", "#FF00FF", "#FFFF00", "#FFFFE0", "#FFFFF0",
            "#FF00FF", "#FF1493", "#FF4500", "#FF6347", "#FF69B4", "#FF7F50", "#FF8C00", "#FFA07A", "#FFA500", "#FFB6C1",
            "#FFC0CB", "#FFD700", "#FFDAB9", "#FFDEAD", "#FFF0F5", "#FFF5EE", "#FFF8DC", "#FFFACD", "#FFFAF0", "#FFFAFA"};
